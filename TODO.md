...
# when the user click delete vm, there is a confirmatin message, would it be beter to add another confirmation with a pop-up windows with the name of the vm in big visible letters?
