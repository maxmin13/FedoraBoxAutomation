...
log_info "Service  : systemctl start|stop|restart|status postgresql"
log_info "CLI      : psql -U postgres"
log_info "Create   : createdb <dbname> -U postgres"
log_info "Logs     : journalctl -u postgresql"
log_info "Config   : /var/lib/pgsql/data/postgresql.conf"
log_info "HBA      : /var/lib/pgsql/data/pg_hba.conf"
