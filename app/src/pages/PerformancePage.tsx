...
const PROC_DESC: Record<string, string> = {
  ...
  'dnf5daemon-server': 'DNF5 background service — handles package install/update/remove requests over D-Bus (used by gnome-software)',
  ...
  'ibus-extension-gtk3': 'IBus GTK3 extension helper — powers the emoji/unicode picker popup',
  ...
  'abrt-dump-journal-oops': 'ABRT helper that scans the systemd journal for kernel oops entries to report',
  'abrt-dump-journal-core': 'ABRT helper that scans the systemd journal for application core dumps to report',
  'abrt-dump-journal-xorg': 'ABRT helper that scans the systemd journal for Xorg (display server) crashes to report',
